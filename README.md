...
You can create new blend shapes by exceeding the limits of existing ones, merging or filtering them, and inserting intermediate frames.
...
3. Assign the target renderer.
4. Add and configure the blend shape definitions.

For more details, please refer to the [documentation](https://blend-shape-modifier.nekobako.net).
